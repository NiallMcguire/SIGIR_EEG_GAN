...
#=========================================================
python /users/gxb18167/SIGIR_EEG_GAN/Deployment/JS-Distance.py --model DCGAN_v1_Text --type normal --generator_path Generation_size_Word_Level_batch_size_64_g_d_learning_rate2e-05_2e-05_word_embedding_dim_50_z_size_100_num_epochs_100_device_cuda:0_model_final.pt
