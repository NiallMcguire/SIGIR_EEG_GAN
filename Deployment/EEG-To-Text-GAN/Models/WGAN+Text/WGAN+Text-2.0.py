...
if __name__ == '__main__':
    ...
    critic_iterations = 5
    save_interval = 5
    checkpoint_path = '/users/Datasets/Checkpoints/WGAN_Text_2.0/Textual_WGAN_GP_checkpoint_epoch_{}.pt'
    final_model_path = '/users/Datasets/Checkpoints/WGAN_Text_2.0/Textual_WGAN_GP_model_final.pt'
