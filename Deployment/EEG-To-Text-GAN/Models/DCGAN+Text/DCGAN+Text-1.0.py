...
if __name__ == '__main__':
    ...
    critic_iterations = 5
    save_interval = 5
    checkpoint_path = '/users/gxb18167/Datasets/Checkpoints/DCGAN_Text_1.0/Textual_WGAN_GP_checkpoint_epoch_{}.pt'
    final_model_path = '/users/gxb18167/Datasets/Checkpoints/DCGAN_Text_1.0/Textual_WGAN_GP_model_final.pt'
