...
#=========================================================
python /users/gxb18167/SIGIR_EEG_GAN/Deployment/Named_Entity_Classification.py --model BLSTM_v1 --epochs 30 --augmentation_size 0 --aug_model NA --generator_path NA
